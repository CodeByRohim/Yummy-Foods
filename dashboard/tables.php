             ...
             <input type="hidden" name="id" class="">
                <div class="row justify-content-around">
                    <div>
                        ...
                        <label class="d-block" for="url">Banner Paragraph </label>
                ...
                <div class="d-flex justify-content-center mt-2"><button class="btn btn-primary" type="submit">Banner Update</button></div>
            </form>
        </div>
    </section>
    <!-- About Us -->
             ...
             <!-- <input type="hidden" name="id" class=""> -->
                ...
                <div class="d-flex text-center mt-3">
                    ...
                    <div>                      
                        ...
                        <label class="d-block" for="video_url">About Us Video Url</label>
                ...
                <div class="d-flex justify-content-center mt-2"><button class="btn btn-primary" type="submit">About Update</button></div>
            </form>
        </div>
    </section>
     <!-- Stats update  -->
                ...
                <div class="row justify-content-around">
                    <div>
                       <input type="hidden" name="id">
                        ...
                        <label class="d-block" for="projects">Stats Projects</label>
                        ...
                        <label class="d-block" for="support">Our Of Support</label>
                        ...
                        <label class="d-block" for="workers">Stats Workers</label>
                    ...
                    <div>
                        <label for="stats-img-input" class="d-block text-center">Stats Background Image </label>
                    <label class="d-block" for="stats-img-input"><img  src="<?= "../uploads/stats/" . $getStats["stats_img"] ?? '' ?>" alt="" class="stats_image img-fluid rounded-circle" style="width:150px; height:150px;object-fit:cover;object-position:center" >
                    </label>
                    <input name="stats_img" class="d-none" id="stats-img-input" type="file" accept="image/*" value="<?= $getStats['stats_img'] ?>">
                    <span class="text-danger"><?= $_SESSION['errors']['stats_error'] ?? '' ?></span>
                    </div>
                </div>
    
                <div class="d-flex justify-content-center mt-2"><button class="btn btn-primary" type="submit">Stats Update</button></div>
            </form>
        </div>
    </section>
     <!-- Menu update  -->
     <section id="menu" class="d-flex justify-content-center">
        ...
        <h4 class="text-center">Menu Update</h4>
            <form action="../controller/MenuUpdateController.php" method="POST" enctype="multipart/form-data">
                ...
                <div class="row justify-content-around">
                    <div>
                       <input type="hidden" name="id" value="<?= $getMenu['id'] ?>">
                        <label class="d-block" for="menu_name">Menu Name</label>
                        ...
                        <label class="d-block" for="menu_details">Menu Details</label>
                        ...
                        <label class="d-block" for="menu_price">Menu Price</label>
                    ...
                    <div>
                        <label for="menu-img-input" class="d-block text-center">Menu Image </label>
                    <label class="d-block" for="menu-img-input"><img  src="<?= "../uploads/menu/" . $getMenu["menu_img"] ?? '' ?>" alt="" class="menu_image img-fluid rounded-circle" style="width:150px; height:150px;object-fit:cover;object-position:center" >
                    </label>
                ...
                <div class="d-flex justify-content-center mt-2"><button class="btn btn-primary" type="submit">Menu Update</button></div>
            </form>
        </div>
    </section>
        ...
        <h4 class="text-center">Contact Info For Home Page Show</h4>
            <form action="../controller/ContactInfoUpdateController.php" method="POST">
              <input type="hidden" name="id">
                ...
                <div class="d-flex justify-content-center mt-2"><button class="btn btn-primary" type="submit">Contact Update</button></div>
            </form>
        </div>
    </section>
    <!-- Book a Table -->
        ...
        <h4 class="text-center">Book a Table</h4>
            <form action="../controller/ContactInfoUpdateController.php" method="POST">
              <input type="hidden" name="id">
                ...
                <div class="d-flex justify-content-center mt-2"><button class="btn btn-primary" type="submit">Book Table Update</button></div>
            </form>
        </div>
     </section>
